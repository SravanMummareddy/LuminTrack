...
export async function updatePlacement(
  ...
  const parsed = placementUpdateSchema.safeParse({
    ...
    endDateNa: formData.get("endDate__na") ?? "",
    clientPoNumber: formData.get("clientPoNumber") ?? "",
    clientPoNumberNa: formData.get("clientPoNumber__na") ?? "",
    invoiceRef: formData.get("invoiceRef") ?? "",
    invoiceRefNa: formData.get("invoiceRef__na") ?? "",
    onsiteManagerName: formData.get("onsiteManagerName") ?? "",
    onsiteManagerNameNa: formData.get("onsiteManagerName__na") ?? "",
    onsiteManagerEmail: formData.get("onsiteManagerEmail") ?? "",
    onsiteManagerEmailNa: formData.get("onsiteManagerEmail__na") ?? "",
    organisation: formData.get("organisation") ?? "",
    organisationNa: formData.get("organisation__na") ?? "",
    teamLead: formData.get("teamLead") ?? "",
    teamLeadNa: formData.get("teamLead__na") ?? "",
    interviewDate: formData.get("interviewDate") ?? "",
    interviewDateNa: formData.get("interviewDate__na") ?? "",
    placementDate: formData.get("placementDate") ?? "",
    placementDateNa: formData.get("placementDate__na") ?? "",
